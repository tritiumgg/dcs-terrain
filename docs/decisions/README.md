...
| [0018](0018-the-window-is-rebuilt-when-it-stops-being-drawn.md) | Accepted | 2026-09-08 | The window is rebuilt when it stops being drawn | ADR 0015's "built once and hidden"; `plan.md` X12, X13, X14 |
