...
| X2a | Config validation over the three fields of ADR 0011, progress log, `dcs.log` lines. Reading and writing the config file belong to X13, which owns it | Every bad config field produces one log line and a disabled run | X1 |
