...
local first_x, first_z = E.cell_center(synth, 0, 0)
T.eq("first cell center x", first_x, S.ORIGIN_X_M + 25)
T.eq("first cell center z", first_z, S.ORIGIN_Z_M + 25)
local last_x, last_z = E.cell_center(synth, synth.height - 1, synth.width - 1)
T.eq("last cell center x", last_x, S.ORIGIN_X_M + size_m - 25)
T.eq("last cell center z", last_z, S.ORIGIN_Z_M + size_m - 25)
